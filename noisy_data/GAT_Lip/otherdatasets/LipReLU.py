...
from GCN_Lip.models import GCN, GCN_layer_3, GCN_layer_4, GCN_layer_5, GCN_layer_6, GCN_layer_7, GCN_layer_8
from GCN_Lip.dataset_process import load_data
from GCN_Lip.otherdatasets.loader import load_new_data
import time
...
if __name__ == '__main__':
    ...
    for epoch in range(400):
        ...
        acc_train, loss_train = train(epoch, u=0.0051, lip_train=False)
